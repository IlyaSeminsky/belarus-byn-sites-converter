# BYN Price Converter — Privacy Policy

_Last updated: 2026-09-19_

BYN Price Converter is a free, open-source browser extension (Chrome MV3).
This page is its official privacy policy and describes exactly what data the
extension accesses and what it does with it.

Source code: <https://github.com/IlyaSeminsky/kufar-usd-converter>

## Summary

**The extension collects no personal data, transmits no user data, and has
no analytics, tracking, or accounts.** Everything it stores stays in your
own browser.

## What the extension does

The extension reads the Belarusian ruble (BYN) prices shown on **kufar.by**
and **av.by** listing, search, and detail pages, and displays an additional
...
- **Exchange rate data** — the extension fetches the current USD/BYN and
  EUR/BYN rates from the NBRB public API
...
If this policy changes, the update will be reflected on this page with a new
"Last updated" date.

## Contact

For questions about this extension, open an issue on the project's GitHub
repository: <https://github.com/IlyaSeminsky/kufar-usd-converter/issues>
...
npm run zip       # production build + releases/byn-price-converter-<version>.zip
npm test          # vitest
